...
declare namespace Hilo {
    ...
    class Camera {
         ...
         */
        public follow(target: object, deadzone:number[]): void;
    ...
    class Camera3d {
         ...
         */
        public project(vector3D: IVector3D, view: View): object;
    ...
    class Matrix {
         ...
         * @returns 一个Matrix对象
         */
        public concat(mtx: Matrix): Matrix;
         ...
         */
        public transformPoint(point: object, round: boolean, returnNew: boolean): object;
    ...
    class LoadQueue {
         ...
         */
        public add(source: ILoadSource | ILoadSource[]): LoadQueue;
         ...
         * @return 资源对象。
         */
        public get(id: string): ILoadSource;
    ...
    class Renderer {
         ...
         */
        public draw(target: View): void;

        /**
         * 结束绘制可视对象后的后续处理方法。需要子类来实现。
         * @param target 要绘制的可视对象。
         */
        public endDraw(target: View): void;
         ...
         */
        public remove(target: View): void;
         ...
         * @param target 要绘制的可视对象。
         */
        public startDraw(target: View): void;
    ...
    class Tween {
         ...
         * @param pause 是否暂停。
         */
        public seek(time: number, pause: boolean): Tween;
         ...
         */
        public setProps(fromProps: object, toProps: object): Tween;
    ...
    class TextureAtlas {
         ...
         * @returns 帧数据。
         */
        public getFrame(index: number): object;
         ...
         * @returns 精灵数据。
         */
        public getSprite(id: string): object;
    ...
    class Ticker {
         ...
         */
        public addTick(tickObject: object): void;
         ...
         */
        public interval(callback: Function, duration: number): object;

        /**
         * 下次tick时回调
         */
        public nextTick(callback: Function): object;
         ...
         * @param tickObject 要添加的定时器对象。此对象必须包含 tick 方法。
         */
        public removeTick(tickObject: object);
         ...
         */
        public timeout(callback: Function, duration: number): object;
    ...
    class Bitmap extends View {
         ...
         * @returns 位图本身。
         */
        public setImage(image: HTMLImageElement | string, rect: number[]):Bitmap
    ...
    class BitmapText extends Container {
         ...
         */
        public setText(text: string): BitmapText;
         ...
         * @returns BitmapText对象本身。链式调用支持。
         */
        public setTextAlign(textAlign): BitmapText;
    ...
    class Button extends View {
         ...
         */
        public disabledState: object;

        /**
         * 按钮按下状态的属性或其drawable的属性的集合。
         */
        public downState: object;
    ...
    class CacheMixin {
         ...
         */
        static cache(forceUpdate: boolean): void;

        /**
         * 设置缓存是否dirty
         * @param dirty 是否dirty
         */
        static setCacheDirty(dirty: boolean): void;
    ...
    class Graphics extends View {
         ...
         * 缓存到图片里。可用来提高渲染效率。
         */
        public cache(forceUpdate: boolean): void;
         ...
         * 设置缓存是否dirty
         */
        public setCacheDirty(dirty: boolean):void;
    ...
    class Sprite extends View {
         ...
         * @returns 精灵帧对象。
         */
        public getFrame(indexOrName: object): object;
         ...
         * @returns 精灵帧对象。
         */
        public getFrameIndex(frameValue: object): object;
         ...
         * @returns Sprite对象本身。
         */
        public setFrame(frame: object, index: number): Sprite;
         ...
         */
        public setFrameCallback(frame: number| string, callback: Function): Sprite
    ...
    class Text extends View {
         ...
         */
        public setFont(font: string): Text;
    ...
    class View {
         ...
         */
        public boundsArea: Array<IHiloPoint>;
