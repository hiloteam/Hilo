...
return {
    /**
     * Get a globally unique id. Such as Stage1, Bitmap2 like.
    ...
    /**
     * It generates a string representaion that contains a path to the specified visual object. Such as Stage1.Container1.Bitmap3.
     * @param {View} view Specified visual objet.
     ...
     * @param {Boolean} strict Indicates whether replication is undefined property, the default is false, i.e., undefined attributes are not copied.
     ...
     * <ul>
     * <li><b>jsVendor</b> - Browser vendor js value CSS prefix. For example: webkit.</li>
     * <li><b>cssVendor</b> - Browser vendor css value CSS prefix. For example: -webkit-.</li>
    ...
    /**
     * Event type enumeration object. Includes：
     * <ul>
     * <li><b>POINTER_START</b> - Mouse or touch start event. Correspondence touchstart or mousedown</li>
     * <li><b>POINTER_MOVE</b> - Mouse or touch event. Correspondence touchmove or mousemove.</li>
    ...
    /**
     * Visual object alignment enumeration object. Includes：
     * <ul>
     ...
     * @returns {Object} DOM element's viewable area. Format {left: 0, top: 0, width:100, height: 100}.
     */
     ...
     * @param {Object} properties Specify properties and styles of DOM elements.
     ...
     * @param {String} id DOM element's id you want to get. 
     * @returns {HTMLElement} A DOM element.
     */
     ...
     * @param {View} obj Specifies the CSS style to set the object with.
     * @private
     */
